...
public class KafkaConfig {
  ...
  public static final String EMAIL_NOTIFICATION_TOPIC = "healthcare.notification.email";
  public static final String EMAIL_GROUP_ID = "healthcare-email-group";
  ...
  public ConsumerFactory<String, Object> consumerFactory() {
    ...
    configProps.put(ConsumerConfig.GROUP_ID_CONFIG, EMAIL_GROUP_ID);
