...
public class EmergencyRequest {
  ...
  public EmergencyRequest(Long id, Hospital hospital, Double userLatitude, Double userLongitude,
                          String emergencyType, String status, String userPhone,
  ...
  public static class Builder {
    ...
    public Builder hospital(Hospital hospital) { this.hospital = hospital; return this; }
    public Builder userLatitude(Double userLatitude) { this.userLatitude = userLatitude; return this; }
    public Builder userLongitude(Double userLongitude) { this.userLongitude = userLongitude; return this; }
    ...
    public EmergencyRequest build() {
      return new EmergencyRequest(id, hospital, userLatitude, userLongitude, emergencyType,
                                  status, userPhone, createdAt, updatedAt);
    }
  }
}
