...
export const EmergencyAssistanceBottomNav: React.FC = () => {
  return (
    <footer className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-4 pt-2 bg-white/80 backdrop-blur-xl z-50 rounded-t-3xl shadow-[0px_-4px_20px_rgba(0,0,0,0.05)]">
      ...
      >
        ...
        <span className="text-[11px] font-semibold tracking-wide uppercase font-label">Home</span>
      </Link>

      <div className="flex flex-col items-center justify-center bg-primary-fixed text-on-primary-fixed rounded-xl px-3 py-1">
        <span
